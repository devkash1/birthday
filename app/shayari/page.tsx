export default function Shayari() {
  return (
    <main className="max-w-screen  bg-red-100 flex justify-center items-center py-8 ">
      <div className="mx-auto px-3 lg:px-5 py-2 shadow-2xl rounded-lg ">
        <p className="text-red-950 text-lg lg:text-xl text-center">
          ...
          Aap mai hi basi hai meri har subah, meri har shaam ki sukoon bhari
          khushi.......
          <br />
          <br />
        </p>
